...
namespace FinalExamWareHouse
{
    public partial class MainForm : Form
    {
        ...
        private void signinbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("All fields have to Filled !!!");
            }
        }
        ...
        private void exitToolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            mainpanel.Show();
            mainmenuStrip.Hide();
            usernametextboxenter.Clear();
            passwordtextboxentering.Clear();
        ...
        private void clientbuttonremove_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (listViewclient.Items.Count > 0 && listViewclient.SelectedItems[0].Text != "")
                {
            ...
            {
                MessageBox.Show("You not selected item for remove!!!");
            }
        }
        ...
        private void deleteproductbutton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (listViewproduct.Items.Count > 0 && listViewproduct.SelectedItems[0].Text != "")
                {
        ...
        private void deleteorderbutton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (listVieworder.Items.Count > 0 && listVieworder.SelectedItems[0].Text != "")
                {
